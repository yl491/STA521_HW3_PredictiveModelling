...
ggplot(vote.glm,aes(x=income,y=vote))+geom_point()+geom_smooth(method="glm")

ggplot( vote.glm, aes(x=income, y=vote)) +
  geom_point() +
  stat_smooth( aes(y = vote),  method="glm", family="binomial", se=F)
```
>>>>>>> 76c83e16affc6bf5e4f791fbe62c3d96d007225a
