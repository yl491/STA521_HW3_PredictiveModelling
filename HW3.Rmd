...
#conf_int$year<-c("1952","1956","1960","1964","1968","1972","1976","1980","1984","1988","1992","1996","2000")
conf_int
...
```{r}
#nes19522000$vote.1 = as.double(nes19522000$vote)
#ggplot()+geom_point(data=nes19522000,aes(income,vote.1),position="jitter")+geom_smooth(data=nes19522000,method="gl#m",method.args=list(family="binomial"),aes(income,vote.1),col="red",se=T)
```
