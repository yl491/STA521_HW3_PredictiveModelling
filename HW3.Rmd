...
#first plot#
ggplot(data=nes1992,aes(x=income,y=as.numeric(vote)))+geom_point(position=position_jitter(width=0.3,height=0.03),shape=21,size=0.01)+geom_smooth(data=nes1992,method="glm",aes(x=income,y=as.numeric(vote)),method.args=list(family="binomial"),fullrange=T,se=F,size=0.5)+scale_x_continuous(limits=c(-5,10))+geom_abline()
