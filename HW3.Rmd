...
```{r}
nes19522000$vote.1 = as.double(nes1952$vote)
ggplot()+geom_point(data=nes19522000,aes(income,vote.1),position="jitter")+geom_smooth(data=nes19522000,method="glm",method.args=list(family="binomial"),aes(income,vote.1),col="red",se=T)
```
