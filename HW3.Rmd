...
done 5.  What does the residual deviance or any diagnostic plots suggest about the model?  (provide code for p-values and output and plots) 
```{r}
...
```{r}
glm3<-glm(formula=vote~gender+race+education+partyidentification+politicalideology+race:education+gender:education, data=nes1992filter,family="binomial")
summary(glm3)
```
