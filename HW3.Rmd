...
for(i in rownames(coefficients(summary(glm3)))){
  table[j,1]<-exp((summary(glm3)$coefficients[j,1])+(summary(glm3)$coefficients[j,2])*(summary(glm3)$coefficients[j,3]))
  table[j,2]<-exp((summary(glm3)$coefficients[j,1])-(summary(glm3)$coefficients[j,2])*(summary(glm3)$coefficients[j,3]))
