...
exp(confint(vote.glm1952,"income"))
exp(confint(vote.glm1956,"income"))
exp(confint(vote.glm1960,"income"))
exp(confint(vote.glm1964,"income"))
exp(confint(vote.glm1968,"income"))
exp(confint(vote.glm1972,"income"))
exp(confint(vote.glm1976,"income"))
exp(confint(vote.glm1980,"income"))
exp(confint(vote.glm1984,"income"))
exp(confint(vote.glm1988,"income"))
exp(confint(vote.glm1992,"income"))
exp(confint(vote.glm1996,"income"))
exp(confint(vote.glm2000,"income"))
...
```{r}
vote.glm_inte<-glm(formula=vote~income+year+income*year,data=nes19522000,family=binomial())
```
